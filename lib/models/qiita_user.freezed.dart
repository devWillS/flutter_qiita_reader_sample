...
class _$QiitaUserTearOff {
  ...
  _QiitaUser call({required String profile_image_url}) {
    return _QiitaUser(
...
abstract class $QiitaUserCopyWith<$Res> {
  ...
  $Res call({String profile_image_url});
}
...
class _$QiitaUserCopyWithImpl<$Res> implements $QiitaUserCopyWith<$Res> {
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      profile_image_url: profile_image_url == freezed
...
class _$_QiitaUser implements _QiitaUser {
  const _$_QiitaUser({required this.profile_image_url});
...
abstract class _QiitaUser implements QiitaUser {
  const factory _QiitaUser({required String profile_image_url}) = _$_QiitaUser;
